    ...
    return (
        <div className='my-24 mx-16'>
            ...
            <div className='flex w-full mx-auto flex-col justify-center items-left'>
                ...
                >
                    <p>-Avoid inline functions as much as possible.<br />
                        -Remember that Immutability is the key to avoid unnecessary re-renders.<br />
                        -Always render hidden components like Modals and Dropdowns conditionally.<br />
                ...
                >
                    <div>
                        <p>
                            There are four main ways of state to properly manage React apps:<br />
                ...
                >
                    <div>
                        <p>
                            1.Import {useState} and set state variables.<br />
                            2.Set a callback function and pass it down as a prop to the Search Component within App.
                        </p>
                    </div>
                </BlogsQA>
